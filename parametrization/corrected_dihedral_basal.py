import os
import shutil
if os.path.exists("corrected_dihedral_basal/"):
    shutil.rmtree("corrected_dihedral_basal/")
    os.mkdir("corrected_dihedral_basal/")
else:
    os.mkdir("corrected_dihedral_basal/")
indir = 'dihedral_id/'
antedir='mol2_basal/'
...
for root, dirs, filenames in os.walk(indir):
    for n in filenames:
        ...
        w=open("corrected_dihedral_basal/"+f.name[len(indir):-4]+'.dat', 'w')
        ...
        for bond in range(0,int(len(table)/5),1):
            ...
            b=a1[8][0]+a1[9][0]+a1[10][0]+'-'+a2[8][0]+a2[9][0]+a2[10][0]+'-'+a3[8][0]+a3[9][0]+a3[10][0]+'-'+a4[8][0]+a4[9][0]+a4[10][0]
            bT=a4[8][0]+a4[9][0]+a4[10][0]+'-'+a3[8][0]+a3[9][0]+a3[10][0]+'-'+a2[8][0]+a2[9][0]+a2[10][0]+'-'+a1[8][0]+a1[9][0]+a1[10][0]
